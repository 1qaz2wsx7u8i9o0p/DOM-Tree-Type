...
void XMLDocumentParser::StartElementNs(const AtomicString& local_name,
  ...
  SetAttributes(new_element, prefixed_attributes, GetParserContentPolicy(), parsing_fragment_);
  if (exception_state.HadException()) {
    StopParsing();
    return;
  }
