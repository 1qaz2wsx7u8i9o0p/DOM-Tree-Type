...
class CORE_EXPORT Element : public ContainerNode, public Animatable {
 ...
 public:
  ...
  void removeAttribute(const QualifiedName&, ExceptionState& = ASSERT_NO_EXCEPTION);
  ...
  Attr* DetachAttribute(wtf_size_t index, ExceptionState&);
  ...
  void ParserSetAttributes(const Vector<Attribute>&, bool);
  ...
  scoped_refptr<ComputedStyle> StyleForLayoutObject(const StyleRecalcContext&, bool&);
  ...
  void ExecutePendingAttributeChanges();
 ...
 private:
  ...
  void DidAddAttribute(const QualifiedName&, const AtomicString&, bool delay_attribute_changed = true);
  ...
  void DidModifyAttribute(const QualifiedName&,
                          const AtomicString& old_value,
                          const AtomicString& new_value,
                          bool delay_attribute_changed = true);
  void DidRemoveAttribute(const QualifiedName&, const AtomicString& old_value, bool delay_attribute_changed = true);
