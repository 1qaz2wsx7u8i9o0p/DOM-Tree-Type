...
WebContentsPreferences::WebContentsPreferences(
  ...
  SetDefaultBoolIfUndefined(options::kNodeIntegration, true);
  ...
  SetDefaultBoolIfUndefined(options::kWebviewTag, true);
...
void WebContentsPreferences::OverrideWebkitPrefs(
  ...
  prefs->context_isolation = IsEnabled(options::kContextIsolation, false);

#if BUILDFLAG(ENABLE_REMOTE_MODULE)
  // Whether to enable the remote module
  prefs->enable_remote_module = IsEnabled(options::kEnableRemoteModule, true);
#endif

  prefs->world_safe_execute_javascript =
      IsEnabled(options::kWorldSafeExecuteJavaScript, false);
